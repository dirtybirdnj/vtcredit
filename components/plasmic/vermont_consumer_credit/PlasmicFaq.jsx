...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: uvD0OplvXorD/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rZ07I)}
      >
        <div className={classNames(projectcss.all, sty.freeBox___4Serv)}>
          <div className={classNames(projectcss.all, sty.freeBox__fhc9I)}>
            {p.renderPlasmicSlot({
